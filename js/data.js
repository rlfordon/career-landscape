  ...
  'inhouse-large': {
    ...
    junior: {
      ...
      descriptions: {
        ...
        selfServiceResistance: 'Business teams are already self-serving: sales using Ironclad for contract review, HR using AI policy drafting, procurement using automated vendor processing. The 2024 ACC survey found 53% of legal departments experimenting with generative AI.',
